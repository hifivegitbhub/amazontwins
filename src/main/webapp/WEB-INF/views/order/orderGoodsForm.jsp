	...
	for(var i=0; i<r_pay_method.length;i++){
	  if(r_pay_method[i].checked==true){
		  ...
		  if(pay_method=="creditCards"){
			...
			pay_method+="<Br>"+
				 		"Credit Card Company: "+card_com_name+"<br>"+
				 		"Installment: "+card_pay_month;
			pay_orderer_hp_num="해당없음";
			
		  }else if(pay_method=="Smart Phone"){
			...
			pay_method+="<Br>"+"Smart Phone Num:"+pay_orderer_hp_num;
			card_com_name="해당없음";
			card_pay_month="해당없음";
		  } //end if
		 break;
...
//	alert("총주문 금액:"+total_order_goods_price);
	...
	delivery_address=i_zipcode.value+"(zip code)"+"<br>"+
						"road base address:"+i_roadAddress.value+"<br>"+
						"[parcel based system:"+i_jibunAddress.value+"]<br>"+
...
<body>
	<div>
		<a href="${contextPath}/main/main.do">
			<img height="90" alt="comazon" src="${contextPath}/resources/image/comazon_logo_signIn.png">
		</a>
	</div>
	
	<form  name="form_order">
		<div id="payment_msg">How would you like to pay?</div>
		...
		<div id="payment_tbl">
			<table>
				<tbody>
					<tr>
						<td>
							<span class="pay_method_select">
								<input type="radio" id="pay_method" name="pay_method" value="creditCards" onClick="fn_pay_card()" checked> credit cards
							</span>
							<span class="pay_method_select">
								<input type="radio" id="pay_method" name="pay_method" value="debitCards"> debit cards
							</span>
							<span class="pay_method_select">
								<input type="radio" id="pay_method" name="pay_method" value="Smart Phone" onClick="fn_pay_phone()"> Smart Phone
							</span>
						</td>
					</tr>
		...
		<a href="${contextPath}/main/main.do"> 
			<input class="ListButton" type="button" value="Cancle">
		</a>
		
		<table class="list_view">
			<tbody align=center>
				<tr style="background: #eeeeee">
					<td colspan=2 class="tbl_txt">Book name</td>
					<td class="tbl_txt">Quantity</td>
					<td class="tbl_txt">Product Price</td>
					<td class="tbl_txt">Shipping Price</td>
					<td class="tbl_txt">Point</td>
				...
				<tr>
					<c:forEach var="item" items="${myOrderList }">
						...
						<td class="tbl_cnt"><h2>$${item.goods_sales_price} (discount 0%)</h2></td> <!-- by me -->
						<td class="tbl_cnt"><h2>$0</h2></td>
						<td class="tbl_cnt"><h2>${150 *item.order_goods_qty}p</h2></td>
						<td class="tbl_cnt">
		...
		<div class="detail_table">
			...
			<table id="visibility_collapse_table">
				<tbody>
					<tr class="dot_line">
		...
		<div >
		  <br><br>
		   <!-- <h2>주문고객</h2> -->
			 <table id="visibility_collapse_table1">
			   <tbody>
				 <tr class="dot_line">
					<td ><h2>이름</h2></td>
					<td>
		...
		<!-- <!-- <H1>3.할인 정보</H1> -->
		<div class="detail_table">
			<table id="visibility_collapse_table2">
				<tbody>
					<tr class="dot_line">
						<td width=100>적립금</td>
		...
		<table width=80% class="list_view" style="background: #ffffff">
			<tbody>
				<tr align=center class="fixed">
					<td class="tbl_txt">Total Quantity</td>
					<td class="tbl_txt">Total Product Price</td>
					<td></td>
					<td class="tbl_txt">Total Shipping Price</td>
					<td></td>
					<td class="tbl_txt">Total Discount Price</td>
					<td></td>
					<td class="tbl_txt">Total Payment Price</td>
				</tr>
				<tr cellpadding=40 align=center>
					<td class="tbl_cnt" id="">
						<p id="p_totalNum">${total_order_goods_qty}ea</p> 
					...
					<td class="tbl_cnt"><IMG width="25" alt=""
					...
					<td class="tbl_cnt">
						<p id="p_totalSalesPrice">$${total_discount_price }</p> 
...
<div class="clear"></div>		
	<div id="layer" style="visibility:hidden">
		...
		<div id="popup_order_detail">
			...
			<div id="popup_detail_title">Review your order</div>
			<table>
				<tbody align=left>
					<tr class="omit_list">
						<td width=200px>
					 	...
					 	<td>
							<p id="p_order_goods_id">Order product number</p>    
						</td>
				   	</tr>
				   	<tr>
						<td width=200px>
					 	...
					 	<td>
							<p id="p_order_goods_title">Product name</p>    
					 	</td>
				   	</tr>
				   	<tr class="omit_list">
						<td width=200px>
						...
						<td>
							<p id="p_total_order_goods_qty">Order product quantity</p>    
						</td>
				   	</tr>
				   	<tr>
						<td width=200px>
						...
						<td>
							<p id="p_total_order_goods_price">Total Price</p>
						</td>
				   	</tr>
					<tr class="omit_list">
						<td width=200px>
				   	...
				   	<tr class="omit_list">
						<td width=200px>
					 	...
					 	<td>
					    	<p id="p_receiver_name">Receiver</p>
					 	</td>
				   	</tr>
				   	<tr class="omit_list">
						<td width=200px>
						...
						<td>
					    	<p id="p_delivery_method">Shipping method</p>
					 	</td>
				   	</tr>
				   	<tr class="omit_list">
						<td width=200px>
						...
						<td>
					    	<p id="p_receiver_hp_num">Phone num</p>
					 	</td>
				   	</tr>
				   	<tr class="omit_list">
						<td width=200px>
					 	...
					 	<td>
					    	<p id="p_receiver_tel_num">Shipping method</p>
					 	</td>
				   	</tr>
				   	<tr>
						<td width=200px>
					 	...
					 	<td align=left>
					    	<p id="p_delivery_address">Address</p>
					 	</td>
				   	</tr>
				    <tr class="omit_list">
						<td width=200px>
					 	...
					 	<td align=left>
					    	<p id="p_delivery_message">Shipping msg</p>
					 	</td>
				   	</tr>
				   	<tr class="omit_list">
						<td width=200px>
						...
						<td align=left>
					    	<p id="p_gift_wrapping">Gift packing</p>
					 	</td>
				   	</tr>
				   	<tr>
						<td width=200px>
					 	...
					 	<td align=left>
					    	<p id="p_pay_method">Payment method</p>
					 	</td>
				   	</tr>
				   	<tr>
				    	<td colspan=2 align=center>
				    		<input class="buyButton" name="btn_process_pay_order" type="button" onClick="fn_process_pay_order()" value="Place your order">
				    	</td>
				   	</tr>
				</tbody>
			</table>

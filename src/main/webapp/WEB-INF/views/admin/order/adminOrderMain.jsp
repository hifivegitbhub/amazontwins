			...
			<table class="outer_table">
				<tbody>
					...
					<tr>
						...
						<td>
							<button type="button" onclick="search_order_history('today')" class="search_period" >당일</button>
							<button type="button" onclick="search_order_history('one_week')" class="search_period" >1주</button>
							<button type="button" onclick="search_order_history('two_week')" class="search_period" >2주</button>
							<button type="button" onclick="search_order_history('one_month')" class="search_period" >1개월</button>
							<button type="button" onclick="search_order_history('two_month')" class="search_period" >2개월</button>
							<button type="button" onclick="search_order_history('three_month')" class="search_period" >3개월</button>
							<button type="button" onclick="search_order_history('four_month')" class="search_period" >4개월</button>
							&nbsp;
						</td>
					</tr>
					<tr>						

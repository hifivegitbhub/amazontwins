...
<body>
	...
	<div class="table_wrap">
		...
		<table class="list_view">
			<tbody>
				<tr>
					<td class="first_td_order">
						이름
					</td>
					<td>
						<div class="td_wrapper">${orderer.member_name}</div>
					</td>
				</tr>
				<tr>
					<td class="first_td_order">
					...
					<td>
						<div class="td_wrapper">${orderer.hp1}-${orderer.hp2}-${orderer.hp3}</div>
					</td>
				</tr>
				<tr>
					<td class="first_td_order">
					...
					<td>
						<div class="td_wrapper">${orderer.email1}@${orderer.email2}</div>
					</td>
				</tr>
			</tbody>
		</table>
		...
		<table class="list_view">
			<tbody>
				<tr>
					...
					<td>
						<div class="td_wrapper">${deliveryInfo.delivery_method}</div>
					</td>
				</tr>
				<tr>
					<td class="first_td_order">
					...
					<td>
						<div class="td_wrapper">${deliveryInfo.receiver_name }</div>
					</td>
				</tr>
				<tr>
					<td class="first_td_order">
					...
					<td>
						<div class="td_wrapper">${deliveryInfo.receiver_hp1}-${deliveryInfo.receiver_hp2}-${deliveryInfo.receiver_hp3}</div>
					</td>
				</tr>
				<tr>
					<td class="first_td_order">
					...
					<td>
						<div class="td_wrapper">${deliveryInfo.receiver_tel1}-${deliveryInfo.receiver_tel2}-${deliveryInfo.receiver_tel3}</div>
					</td>
				</tr>
				<tr>
					<td class="first_td_order">
					...
					<td>
						<div class="td_wrapper">${deliveryInfo.delivery_address}</div>
					</td>
				</tr>
				<tr>
					<td class="first_td_order">
					...
					<td>
						<div class="td_wrapper">${deliveryInfo.delivery_message}</div>
					</td>
				</tr>
				<tr>
					<td class="first_td_order">
					...
					<td>
						<div class="td_wrapper">${deliveryInfo.gift_wrapping}</div>
					</td>
				</tr>
			</tbody>
		</table>
		...
		<table class="list_view">
			<tbody>
				<tr>
					...
					<td>
						<div class="td_wrapper">${deliveryInfo.pay_method }</div>
					</td>
				</tr>
				<tr>
					<td class="first_td_order">
					...
					<td>
						<div class="td_wrapper">${deliveryInfo.card_com_name}</div>
					</td>
				</tr>
				<tr>
					<td class="first_td_order">
					...
					<td>
						<div class="td_wrapper">${deliveryInfo.card_pay_month }</div>
					</td>
				</tr>
			</tbody>
		</table>
				...
				<tr>
					...
					<td>
						<div class="td_wrapper">
							...
							<input type="button" class="btn" value="배송수정"  onClick="fn_modify_order_state('${deliveryInfo.order_id}')"/>
						</div>
					</td>
				</tr>
			</tbody>

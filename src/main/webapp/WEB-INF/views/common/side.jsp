...
<c:when test="${side_menu=='admin_mode' }">
   <li>
		<H3><spring:message code="side.mainfunction" text="*" /></H3>
		<ul>
			<li><a href="${contextPath}/admin/goods/adminGoodsMain.do"><spring:message code="side.productmgt" text="*" /></a></li>
			<li><a href="${contextPath}/admin/order/adminOrderMain.do"><spring:message code="side.ordermgt" text="*" /></a></li>
			<li><a href="${contextPath}/admin/member/adminMemberMain.do"><spring:message code="side.customermgt" text="*" /></a></li>
			<li><a href="#"><spring:message code="side.deliverymgt" text="*" /></a></li>
			<li><a href="#"><spring:message code="side.boardmgt" text="*" /></a></li>
		</ul>
	</li>
</c:when>
<c:when test="${side_menu=='my_page' }">
	<li>
		<h3><spring:message code="side.orderhistory" text="*" />주문내역</h3>
		<ul>
			<li><a href="${contextPath}/mypage/listMyOrderHistory.do"><spring:message code="side.orderdelivery" text="*" />주문내역/배송 조회</a></li>
			<li><a href="#"><spring:message code="side.refundreturn" text="*" />반품/교환 신청 및 조회</a></li>
			<li><a href="#"><spring:message code="side.cancelhistory" text="*" />취소 주문 내역</a></li>
			<li><a href="#"><spring:message code="side.taxbill" text="*" />세금 계산서</a></li>
		</ul>
	</li>
	<li>
		<h3>정보내역</h3>
